...
import com.becxpress.whi.ViewModel.OrderingViewModel;
import com.becxpress.whi.databinding.ActivityOrderProductBinding;
...
import static com.becxpress.whi.utils.Constant.PRODUCTID;
...
public class OrderProductActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void orderProduct() {
        ...
        orderingViewModel.orderProduct(ordering).observe((LifecycleOwner) this, responseBody -> {
            try {
                Toast.makeText(OrderProductActivity.this, responseBody.string() + "", Toast.LENGTH_SHORT).show();
                finish();
                Intent homeIntent = new Intent(OrderProductActivity.this, com.becxpress.whi.view.ProductActivity.class);
