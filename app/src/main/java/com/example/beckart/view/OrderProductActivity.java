...
import com.example.beckart.ViewModel.OrderingViewModel;
import com.example.beckart.databinding.ActivityOrderProductBinding;
    ...
    private void orderProduct() {
        ...
        orderingViewModel.orderProduct(ordering).observe((LifecycleOwner) this, responseBody -> {
            try {
                ...
                finish();
                Intent homeIntent = new Intent(OrderProductActivity.this, com.example.beckart.view.ProductActivity.class);
