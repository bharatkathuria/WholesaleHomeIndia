...
public class CookerDataSourceFactory extends DataSource.Factory{
    ...
    public static com.example.beckart.net.ProductDataSource cookerDataSource;
    ...
    public DataSource<Integer, Product> create() {
        ...
        cookerDataSource = new com.example.beckart.net.ProductDataSource(category,userId);
